...
// MSVC ARM64: __ARM_NEON is defined but all NEON vector types alias to __n128,
// causing duplicate template specializations in xsimd. Use generic path on MSVC.
