...
// MSVC (C3200) rejects passing a single-parameter class template (e.g.
// reader_node) as a template <class> class argument. A variadic
// template-template parameter accepts it and is equally valid on GCC/Clang.
