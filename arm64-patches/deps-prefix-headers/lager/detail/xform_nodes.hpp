...
class xform_cursor_node : public xform_reader_node<Xform, Parents, ::lager::detail::cursor_node>
{
    using base_t  = xform_reader_node<Xform, Parents, ::lager::detail::cursor_node>;
